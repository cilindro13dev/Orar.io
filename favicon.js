function setFavicon(color = "#3498db") {
  // SVG-шаблон с подстановкой цвета в fill
  const svgContent = `
    <svg fill="${color}" width="256px" height="256px" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
  ...
  // Ищем или создаем тег <link rel="icon">
...
// Устанавливаем цвет при загрузке страницы (укажите нужный HEX или RGB)
